...
class TableViewCellWithImage: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        self.textLabel?.frame = CGRectMake((self.imageView?.frame.size.width)! + 2 * decalage, 0.0, self.frame.size.width - (self.imageView?.frame.size.width)! - 3 * decalage - 30.0, self.frame.size.height)
